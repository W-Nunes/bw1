...
<div class="main-container">
	...
	<nav class="navbar fixed-top ">
		<div class="header  limit-section">
			<a class="navbar-brand" href="index.php">
				<img src="./img/logo.png"  class="d-inline-block align-text-top logotipo">
...
<?php } } ?>
	 ...
	 <!-- Menu Start -->
        <div class=" limit-section container-xxl py-5 margin_top_web" style="margin: 0rem auto">
                	 ...
                	 <ul class="nav nav-pills d-inline-flex justify-content-center border-bottom mb-5" style="width:100%;">
                        <li class="nav-item" style="width:34%;">
                            <a class="d-flex align-items-center text-start mx-3 ms-0 pb-3 active" data-bs-toggle="pill" href="#tab-1">
                                <img class="icone_mobile" src="img/categorias.png" width="50px" height="50px">
                                <div class="ps-1">
                        ...
                        <li class="nav-item" style="width:34%;">
                            <a class="d-flex align-items-center text-start mx-3 pb-3" data-bs-toggle="pill" href="#tab-2">
                                 <img class="icone_mobile" src="img/favoritos.png" width="50px" height="50px">
                                <div class="ps-1">
			...
			for($i2=0; $i2 < $tem_produto; $i2++){
				...
				?>
                                ...
                                <div class="col-md-6">
                                  ...
                                  <?php } ?>
                                    <div class="d-flex align-items-center card-border">
                                        <img class="flex-shrink-0 img-fluid " src="sistema/painel/images/categorias/<?php echo $foto ?>" alt="" style="width: 40px;">
...
$total_adc = @count($res3);
	...
	<footer class="rodape ">	
		<div class="container-rodape limit-section">
		    <img class="logotipofooter" src="./img/logo.png"/">
		    
		    <div class="container-info-footer">
		        <h4 class="title-footer">CONTATO</h4>
		            <div >
		               <span style="width: 100%; display: block;"><a target="_blank" href="https://api.whatsapp.com/send/?phone=552137965239&text&type=phone_number&app_absent=0" class="link-neutro"><i class="bi bi-whatsapp text-success"> (21)3796-5239</i></a></span> 
		            </div>
		    </div>     
		    
		    
		       <div class="container-info-footer">
		        <h4 class="title-footer">LOCALIZAÇÃO</h4>
		            <div >
		               <span style="width: 100%; display: block;"><a target="_blank" href="https://maps.app.goo.gl/uhVkAuvC5ao86ecN9" class="link-neutro"><i class="bi  text-success"> Av. Mem de Sá, 17 - Lapa</i></a></span> 
		            </div>
		        </div>  
		        
		        
		         <div class="container-info-footer">
		        <h4 class="title-footer">SIGA NOSSAS REDES</h4>
		            <div >
		               <span style="width: 100%"><a target="_blank" href="https://www.instagram.com/barboseirabebidas/" class="link-neutro"><i class="bi bi-instagram" style="color:#d11144"></i> Instagram</a></span> 
		            </div>
		        </div>  
		        
		        
		           <div class="container-info-footer">
		        <h4 class="title-footer">PAINEL SISTEMA</h4>
		            <div >
		               <span> <a href="sistema" class="link-neutro "><i class="bi bi-lock" style="color:red"></i> Painel Sistema</a></span>
		            </div>
		        </div>  
	    ...
	    <div id="copy">
	        Copyright &copy;<script>document.write(new Date().getFullYear());</script> Barboseira Bebidas <i class="fa fa-heart" aria-hidden="true"></i> by <a  href="https://www.suporteverde.com" target="_blank">Suporte Verde</a>
	    </div>
