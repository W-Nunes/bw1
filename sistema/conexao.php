...
//$servidor = '127.0.0.1';
 ...
 //$usuario = 'u428276314_barboseira';
// $senha = 'Barboseira123';
// $banco = 'u428276314_barboseira';
 //$servidor = 'localhost';

//dbtest
 $usuario = 'u428276314_barb_tests';
 $senha = 'Barb_tests123';
 $banco = 'u428276314_barb_tests';
 $servidor = 'localhost';
...
try {
    $pdo = new PDO("mysql:dbname=$banco;host=$servidor;charset=utf8", $usuario, $senha); // Correto: $pdo é definido aqui
    $pdo->exec("SET time_zone = '-03:00';"); // Correto: agora $pdo existe e pode executar o comando
} catch (Exception $e) {
    echo 'Não foi possível conectar ao banco de dados! <br><br>' . $e->getMessage();
}

$nome_sistema = 'Baboseira Bebidas - Delivery ';
$email_sistema = 'contato@todososfilhos.com.br';
$telefone_sistema = '(21) 3796-5239';
