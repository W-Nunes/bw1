                        ...
                        <div class="logo-search-category-wrapper">
                            ...
                            <div class="accont-wishlist-cart-area-header">
                                ...
                                <!-- <a href="wishlist.html" class="btn-border-only wishlist">
                                    ...
                                    <span class="accont-span">Wishlist</span>
                                    ...
                                    <div class="category-sub-menu card-number-show">
                                        ...
                                        <div class="sub-total-cart-balance">
                                            <div class="bottom-content-deals mt--10">
                                                <div class="top">
                                                    <span>Sub Total:</span>
                                                    <span class="number-c">RR$108.00</span>
                                                </div>
                                                ...
                                                <p>Spend More <span>RR$125.00</span> to reach <span>Free Shipping</span></p>
                                            </div>
                        ...
                        <div class="category-sub-menu card-number-show">
                            ...
                            <div class="sub-total-cart-balance">
                                <div class="bottom-content-deals mt--10">
                                    <div class="top">
                                        <span>Sub Total:</span>
                                        <span class="number-c">R$108.00</span>
                                    </div>
                                    <div class="single-progress-area-incard">
                                        <div class="progress">
                                    ...
                                    <p>Spend More <span>R$125.00</span> to reach <span>Free Shipping</span></p>
                                </div>
                                <div class="button-wrapper d-flex align-items-center justify-content-between">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            if($total_reg > 0) {
                                foreach($res as $categoria) {
                                    ...
                                    $url = $categoria['url'];
                                    $id = $categoria['id'];
                                    $mais_sabores = $categoria['mais_sabores'];
                                    
                                    // Verificando a URL da categoria para direcionar ao link correto
                                    $link_categoria = $mais_sabores == 'Sim' ? 'categoria-sabores-' . $url : 'categoria-' . $url;
                                    ?>
                                    <div class="swiper-slide">
                                        <a href="<?php echo $link_categoria; ?>" class="single-category-one">
                                            <img src="sistema/painel/images/categorias/<?php echo $foto ?>" alt="category">
                                            <p><?php echo $nome; ?></p>
                                        </a>
                                    </div>
                                    <?php 
...
<!-- End of CATEGORIAS -->
    ...
    <div class="row m-5">
        ...
        <div class="tab-content" id="myTabContent">
                    ...
                    <div class="col-lg-20 col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="single-shopping-card-one">
                            ...
                            <div class="body-content">
                                ...
                                <a href="shop-details.html">
                                    <h4 class="title">Brahma</h4>
                                </a>
                                <span class="availability">1 Litro</span>
                                <div class="price-area">
                                    <span class="current">R$9.90</span>
                                    <div class="previous">R$9.90</div>
                                </div>
                    ...
                    <div class="col-lg-20 col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="single-shopping-card-one">
                            ...
                            <div class="body-content">
                                ...
                                <a href="shop-details.html">
                                    <h4 class="title">Stella Artois</h4>
                                </a>
                                <span class="availability">1 Litro</span>
                                <div class="price-area">
                                    <span class="current">R$9.90</span>
                    ...
                    <div class="col-lg-20 col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="single-shopping-card-one">
                            ...
                            <div class="body-content">
                                ...
                                <a href="shop-details.html">
                                    <h4 class="title"> Cerveja Stella Artois</h4>
                                </a>
                                <span class="availability">1 Litro</span>
                                <div class="price-area">
                                    <span class="current">R$9.90</span>
                    ...
                    <div class="col-lg-20 col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="single-shopping-card-one">
                            ...
                            <div class="body-content">
                                ...
                                <a href="shop-details.html">
                                    <h4 class="title">Cerveja Skol</h4>
                                </a>
                                <span class="availability">1 Litro</span>
                                <div class="price-area">
                                    <span class="current">R$9.90</span>
                    ...
                    <div class="col-lg-20 col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="single-shopping-card-one">
                            ...
                            <div class="body-content">
                                ...
                                <a href="shop-details.html">
                                    <h4 class="title">Cerveja Original</h4>
                                </a>
                                <span class="availability">1 Litro</span>
                                <div class="price-area">
                                    <span class="current">R$9.90</span>
                    ...
                    <div class="col-lg-20 col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="single-shopping-card-one">
                            ...
                            <div class="body-content">
                                ...
                                <a href="shop-details.html">
                                    <h4 class="title">Cerveja Sparten</h4>
                                </a>
                                <span class="availability">1 Litro</span>
                                <div class="price-area">
                                    <span class="current">R$9.90</span>
                    ...
                    <div class="col-lg-20 col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="single-shopping-card-one">
                            ...
                            <div class="body-content">
                                ...
                                <a href="shop-details.html">
                                    <h4 class="title">Cerveja Brahma</h4>
                                </a>
                                <span class="availability">1 Litro</span>
                                <div class="price-area">
                                    <span class="current">R$9.90</span>
                    ...
                    <div class="col-lg-20 col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="single-shopping-card-one">
                            ...
                            <div class="body-content">
                                ...
                                <a href="shop-details.html">
                                    <h4 class="title">Cerveja Budweiser</h4>
                                </a>
                                <span class="availability">1 Litro</span>
                                <div class="price-area">
                                    <span class="current">R$9.90</span>
            ...
            <div class="product-area-wrapper-shopgrid-list with-list mt--20 tab-pane fade" id="profile-tab-pane"
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="footer-main-content-wrapper pb--70 pb_sm--30">
                        ...
                        <!-- single footer area wrapper -->
                        <div class="single-footer-wized">
                            <h3 class="footer-title">Cartão Presente</h3>
                            <div class="footer-nav">
                                <ul>
                                    <li><a href="#">Comprar aqui</a></li>
            ...
            <div class="product-details-popup">
                ...
                <div class="details-product-area">
                    ...
                    <div class="contents">
                        ...
                        <span class="product-price"><span class="old-price">R$9.35</span> R$7.25</span>
                        <p>
