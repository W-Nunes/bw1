  ...
  <div class="accordion" id="accordionExample" style="margin-top: 55px; margin-bottom: 130px; overflow: scroll; height:100%; scrollbar-width: thin; z-index: 100">
    <div class="accordion-item">
      <h2 class="accordion-header" id="headingOne">
        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" style="font-size:14px">
          1 - IDENTIFICAÇÃO
        </button>
      </h2>
      <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
        <div class="accordion-body" align="center">
          ...
          <?php if ($id_usuario == "") { ?>
            <div class="nome_user">
              <input onclick="buscarNome()" type="text" class="input" name="nome" id="nome" required value="" placeholder="Seu Nome" style="width:150px; text-align: center; border:0" oninput="this.value = this.value.replace(/[^a-zA-Z\s]/g, '')" autocomplete="off">
              <input onkeyup="buscarNome()" type="text" class="input telefone_user" name="telefone" id="telefone" required value="" placeholder="(00) 00000-0000" style="width:150px; text-align: center; border:0; margin-top: -15px" autocomplete="off">
            <?php } else { ?>
      ...
      <div class="accordion-item <?php echo $esconder_opc_delivery ?>">
        <h2 class="accordion-header" id="headingTwo">
          <button id="colapse-2" class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" style="font-size:14px">
            2 - MODO DE ENTREGA
          </button>
        </h2>
      ...
      <div class="accordion-item <?php echo $esconder_opc_delivery ?>">
        <h2 class="accordion-header" id="headingThree">
          <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree" id="colapse-3" style="font-size:14px">
      ...
      <div class="accordion-item">
        ...
        <div id="collapse4" class="accordion-collapse collapse" aria-labelledby="heading4" data-bs-parent="#accordionExample">
          <div class="accordion-body">
            ...
            <div class="row itens-metodo-de-pagamento" style="font-size:14px">
              ...
              <div class="col-3 form-check">
                <small>Dinheiro
                  <input onchange="if(validarBairroParaPagamento(this)) dinheiro();" class="form-check-input" type="radio" name="radio_dinheiro" id="radio_dinheiro">
                </small>
              </div>
              ...
              <div class="col-3 form-check">
                <small>Crédito
                  <input onchange="if(validarBairroParaPagamento(this)) credito();" class="form-check-input" type="radio" name="radio_credito" id="radio_credito">
                </small>
              </div>

              <div class="col-3 form-check">
                <small>Débito
                  <input onchange="if(validarBairroParaPagamento(this)) debito();" class="form-check-input" type="radio" name="radio_debito" id="radio_debito">
                </small>
              </div>
            ...
            <div id="pagar_dinheiro" style="margin-top: 15px">
              ...
              <div class="row">
                <div class="ajuste-troco">
                  <small>Precisa de Troco? </small>
                </div>
                <div class="ajuste" style="margin-top: -13px">
                  <div class="group">
